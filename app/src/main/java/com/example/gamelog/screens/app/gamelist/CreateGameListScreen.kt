...
@Composable
fun CreateGameListScreen(paddingValues: PaddingValues, viewModel: CreateGameListViewModel) {
    Column(
        modifier = Modifier
            .fillMaxSize()
...
@Composable
private fun GameSelectionDialog(viewModel: CreateGameListViewModel) {
    AlertDialog(
